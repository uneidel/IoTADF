...
namespace Iot
{
    ...
    public class IOTHubImportActivity : Microsoft.DataFactories.Runtime.IDotNetActivity
    {
        ...
        #region old code
        /// <summary>
        /// obsolete since this method jsut allows to export 1000 devices
        /// </summary>
        ...
        private async void BulkImport()
        {
            ...
            var storageSAS = SASTokenGenerator.ContainerSaSUri(dataStorageAccountName, iothubName +"out", dataStorageAccountKey);
